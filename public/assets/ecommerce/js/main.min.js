        ...
        var e,
            ...
            c = {
                ...
                minipopup: {
                    ...
                    action: '<a href="/carts" class="btn viewcart">View Cart</a><a href="/checkouts" class="btn btn-dark checkout">Checkout</a>',
                    delay: 4e3,
                    space: 20,
                    template:
                ...
                filterSlider: function () {
                    ...
                    $("#sliderValueStart").val(parseInt(e.noUiSlider.get()));

                    e.noUiSlider.on("change", function () {
                        $("#sliderValueStart").val(
                            parseInt(e.noUiSlider.get()[0])
                        );

                        $("#sliderValueEnd").val(
                            parseInt(e.noUiSlider.get()[1])
                        );
                    });
                },
                                ...
                                success: function ({ success, message }) {
                                    if (success) {
                                        i.removeClass(
                                            ...
                                            t(".wishlist-popup").addClass(
                                                "active"
                                            );

                                        setTimeout(function () {
                                            t(".wishlist-popup").removeClass(
                                                "active"
                                            );
                                        }, 3e3);
                                    }
