...
@section('main')
    <div class="page-header page-header-bg text-left"
        style="background: 50%/cover #D4E1EA url('{{ asset('assets/ecommerce/images/page-header-bg.jpg') }}');">
        <div class="container">
            ...
            <div class="testimonials-carousel owl-carousel owl-theme images-left"
                ...
                <div class="testimonial">
                    <div class="testimonial-owner">
                        <figure>
                            <img src="{{ asset('assets/ecommerce/images/clients/client1.png') }}" alt="client">
                        </figure>
                ...
                <div class="testimonial">
                    <div class="testimonial-owner">
                        <figure>
                            <img src="{{ asset('assets/ecommerce/images/clients/client2.png') }}" alt="client">
                        </figure>
                ...
                <div class="testimonial">
                    <div class="testimonial-owner">
                        <figure>
                            <img src="{{ asset('assets/ecommerce/images/images/clients/client1.png') }}" alt="client">
                        </figure>
