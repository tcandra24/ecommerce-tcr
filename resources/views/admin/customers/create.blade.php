...
@section('main')
    ...
    @endif
    <form class="ecommerce-form action-buttons-fixed" id="form" action="/admin/customers" method="POST">
        @csrf
        <div class="row">
            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                ...
                                <div class="form-group row pb-4">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        <textarea class="form-control form-control-modern" name="address" cols="30" rows="5" required></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
