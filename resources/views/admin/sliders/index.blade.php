                                ...
                                @foreach ($sliders as $slider)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="image-popup-no-margins" href="{{ $slider->image }}">
                                                <img class="img-fluid rounded" src="{{ $slider->image }}" width="120" />
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td class="actions">
                                            @can('master.sliders.edit')
                                                <a href="/admin/sliders/{{ $slider->id }}/edit">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                            @endcan
                                            @can('master.sliders.delete')
                                                <a href="javascript:void(0)" class="delete-row" data-id="{{ $slider->id }}"
                                                    data-name="{{ $slider->name }}">
                                                    <i class="far fa-trash-alt"></i>
                                                </a>
                                                <form id="form-delete-sliders-{{ $slider->id }}" method="POST"
