...
@section('main')
    ...
    @endif
    <form class="ecommerce-form action-buttons-fixed" id="form" action="/admin/roles" method="POST">
        @csrf
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Info Role</h2>
                                <p class="card-big-info-desc">Add here the role description with all details and necessary
                                    information.</p>
                            </div>
                            <div class="col-lg-3-5 col-xl-4-5">
                                ...
                                <div class="form-group row pb-4">
                                    <label
                                        class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Permissions</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <select multiple data-plugin-selectTwo name="permissions[]"
                                            class="form-control populate" id="permissions" aria-describedby="permissions"
                                            required>
