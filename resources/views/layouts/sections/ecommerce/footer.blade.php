                ...
                <div class="col-lg-3 col-sm-6 pb-4 pb-sm-0">
                    <div class="widget mb-2">
                        ...
                        <ul class="contact-info">
                            ...
                            <li>
                                <span class="contact-info-label">Phone:</span><a href="tel:">Toll Free
                                    (123)
                                    456-7890</a>
                            </li>
                            <li>
                                <span class="contact-info-label">Email:</span> <a
                                    href="https://portotheme.com/cdn-cgi/l/email-protection#91fcf0f8fdd1f4e9f0fce1fdf4bff2fefc"><span
                                        class="__cf_email__"
                                        data-cfemail="c5a8a4aca985a0bda4a8b5a9a0eba6aaa8">[email&#160;protected]</span></a>
                            </li>
                            <li>
